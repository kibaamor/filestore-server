...
const (
	serverAddr = "http://172.18.126.117:8080"
	filename   = "/home/k/qemu/qemu-6.2.0.tar.xz"
)
...
func main() {
	username := "admin"
	token := "eeefb6c4ff5fa3c0cf69191d4c4b6c11621f178e"
	...
	fmt.Printf("file sha1 sum: %s\n", filehash)
	// cat `ls | sort -n` | sha1sum
}
